...
use Gaya\PhpSandboxBundle\Exception\PhpSandboxGenericError;
...
class PhpSandboxErrorHandler
{
	...
	public static function throwException($errorType, $errorLog)
	{
		...
		switch ($errorType)
		{
			case self::PHP_NOTICE: throw new PhpSandboxNotice($errorMessage, $errorType); break;
			case self::PHP_WARNING: throw new PhpSandboxWarning($errorMessage, $errorType); break;
			case self::PHP_PARSE_ERROR: throw new PhpSandboxError($errorMessage, $errorType); break;
			case self::PHP_FATAL_ERROR: throw new PhpSandboxError($errorMessage, $errorType); break;
